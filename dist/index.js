...
(() => {
  ...
  function animateSwiperSlides() {
    ...
    gsapWithCSS.set(".button.is-icon", { display: "flex", opacity: 1 });
    ...
    document.querySelectorAll(".swiper-slide").forEach((slide) => {
      slide.addEventListener("click", (event) => {
        ...
        gsapWithCSS.to(sliderP, { opacity: 1, duration: 0.25 });
        gsapWithCSS.to(buttonSlider, { display: "flex", opacity: 1, duration: 0.25 });
        gsapWithCSS.to(sliderCardsH, { scale: 2, duration: 0.25 });
        gsapWithCSS.to(sliderCardsOverlay, { opacity: 1, duration: 0.25 });
        ...
        siblings.forEach((sibling) => {
          ...
          const sliderP2 = sibling.querySelector(".slider_p");
          const buttonSlider2 = sibling.querySelector(".button.is-icon");
          const sliderCardsH2 = sibling.querySelector(".slider_cards-h");
          const sliderCardsOverlay2 = sibling.querySelector(".slider_cards-c-overlay");
          gsapWithCSS.to(sliderP2, { opacity: 0, duration: 0.25 });
          gsapWithCSS.to(buttonSlider2, { display: "flex", opacity: 0, duration: 0.25 });
          gsapWithCSS.to(sliderCardsH2, { scale: 1, duration: 0.25 });
          gsapWithCSS.to(sliderCardsOverlay2, { opacity: 0, duration: 0.25 });
        });
      });
    });
  }
